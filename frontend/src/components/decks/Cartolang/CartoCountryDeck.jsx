...
export const CartoCountryDeck = ({ deck, callBackFunction, }) => {
    ...
    return (
        <>
                    ...
                    <Box className={`ml-2 px-2`}
                        ...
                        <Box className='px-4'>
                            <Typography variant="h4">
                                {wfb_facts.Country_name.local_long_form}
                            </Typography>
                        </Box>
                        <Box className='px-4'>
                            <Typography variant="body2">
                                {wfb_facts.Country_name.etymology}
                            </Typography>
                        </Box>
                    </Box>
                    <Box className={`ml-2 px-2`}
            ...
            <section>
                <CartoCountryDeckLanguages country_languages={country_languages}>

                </CartoCountryDeckLanguages>
            </section>
        </>
    )
}
