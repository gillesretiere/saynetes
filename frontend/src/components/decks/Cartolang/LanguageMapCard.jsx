  ...
  componentDidUpdate(oldProps) {
    ...
    if (this.props.language.language_uid) {
      ...
      */
      ...
      console.log (vk_world);

      // groupe A : très élevé
      let vk_selA = country_points.features.map(a => [a.properties.country_iso2, Number(a.properties.popularity)]);
      let vk_grpA = vk_selA.filter( (x) => x[1] < 0.9).map(a => a[0]);
      console.log (vk_selA);
      console.log (vk_grpA);
      vk_diff = vk_diff.concat(vk_grpA);
      console.log (vk_diff);
